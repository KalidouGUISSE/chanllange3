...
<?php
    require_once "../templaye/layoute/parsialle/header.html.php"
?>
<?php
...
<?php
//copier une des vue et on la colle icie 
//et supprimer la views
//
//creer une variable $containeteForLayoute -> elle doit contenir nos view
?>
